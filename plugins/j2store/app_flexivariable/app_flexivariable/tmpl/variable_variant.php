                ...
                <div id="collapse<?php echo $this->variant->j2store_variant_id; ?>"
                    ...
                    <div class="panel-body">
                        <div class="row-fluid">
                            <div class="span2">
                                <div class="j2store-product-general">
                                    <div class="control-group">
                                        ...
                                        <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_SKU'), 'sku', array('class' => 'control-label')); ?>
                                        <?php echo J2Html::text($prefix . '[sku]', $this->variant->sku, array('class' => 'input-small', 'id' => 'sku_' . $this->variant->j2store_variant_id)); ?>
                                    </div>
                                    <div class="control-group">
                                        <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_UPC'), 'upc', array('class' => 'control-label')); ?>
                                        <?php echo J2Html::text($prefix . '[upc]', $this->variant->upc, array('class' => 'input-small', 'id' => 'upc_' . $this->variant->j2store_variant_id)); ?>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_REGULAR_PRICE'), 'price', array('class' => 'control-label')); ?>
                                    <?php echo J2Html::price($prefix . '[price]', $this->variant->price, array('class' => 'input-small', 'id' => 'price_' . $this->variant->j2store_variant_id)); ?>
                                </div>
                                <div class="control-group">
                                    <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_SET_ADVANCED_PRICING'), 'sale_price', array('class' => 'control-label')); ?>
                                    ...
                                    <?php echo J2StorePopup::popup($url, Text::_("J2STORE_PRODUCT_SET_PRICES"), array('class' => 'btn btn-success btn-small')); ?>
                                </div>
                                <div class="control-group">
                                    <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_PRICING_CALCULATOR'), 'pricing_calculator', array('class' => 'control-label input-small')); ?>
                                    <?php
                                    //pricing options
                            ...
                            <div class="span6">
                                <div class="control-group">
                                    <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_ENABLE_SHIPPING'), 'shipping', array('class' => 'control-label')); ?>
                                    ...
                                    echo J2Html::select()->clearState()
                                        ...
                                        ->setPlaceHolders(array(1 => Text::_('JYES'), 0 => Text::_('JNO')))
                                        ->getHtml();
                                    ?>
                                </div>
                                <div class="control-group">
                                    <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_DIMENSIONS'), 'dimensions', array('class' => 'control-label')); ?>
                                ...
                                <div class="control-group">
                                    <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_LENGTH_CLASS'), 'length_class', array('class' => 'control-label')); ?>
                                ...
                                <div class="control-group form-inline">
                                    <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_WEIGHT'), 'weight', array('class' => '')); ?>
                                ...
                                <div class="control-group">
                                    <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_MAIN_IMAGE'), 'main_image', array('class' => 'control-label')); ?>
                                    ...
                                    <input id="variant_thum_<?php echo $this->variant->j2store_variant_id; ?>"
                                        ...
                                        <?php echo (isset($is_main_as_thum) && $is_main_as_thum) ? 'checked="checked"' : ''; ?>
                                           value="1"/>
                                    <?php echo Text::_('J2STORE_PRODUCT_IS_MAIN_IMAGE_AS_THUM'); ?>
                                </div>
                            </div>
                            <div class="span4">
                                <?php if (J2Store::isPro() == 1) : ?>
                                    <div class="j2store-product-general">
                                        <div class="control-group form-inline">
                                            <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_MANAGE_STOCK'), 'manage_stock', array('class' => 'control-label')); ?>
                                            ...
                                            echo J2Html::select()->clearState()
                                                ...
                                                ->setPlaceHolders(array(0 => Text::_('JNO'), 1 => Text::_('JYES')))
                                                ->getHtml();
                                            ?>

                                        </div>
                                        <div class="control-group">
                                            <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_QUANTITY'), 'quantity', array('class' => 'control-label'));
                                        ...
                                        <div class="control-group">
                                            <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_ALLOW_BACK_ORDERS'), 'allow_backorder', array('class' => 'control-label')); ?>
                                            <?php
                                        ...
                                        <div class="control-group">
                                            <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_STOCK_STATUS'), 'availability', array('class' => 'control-label')); ?>
                                        ...
                                        <div class="control-group">
                                            <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_NOTIFY_QUANTITY'), 'notify_qty', array('class' => 'control-label')); ?>
                                        ...
                                        <div class="control-group">
                                            <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_QUANTITY_RESTRICTION'), 'quantity_restriction', array('class' => 'control-label')); ?>
                                        ...
                                        <div class="control-group form-inline">
                                            <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_MAX_SALE_QUANTITY'), 'max_sale_qty', array('class' => 'control-label')); ?>
                                            <?php
                                        ...
                                        <div class="control-group form-inline">
                                            <?php echo J2Html::label(Text::_('J2STORE_PRODUCT_MIN_SALE_QUANTITY'), 'min_sale_qty', array('class' => 'control-label')); ?>
                                            <?php
                                ...
                                <?php else: ?>
                                    <div class="well">
                                        <p class="lead"> <?php echo Text::_('J2STORE_PRODUCT_MANAGE_STOCK'); ?>  </p>
                                        <?php echo J2Html::pro(); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
