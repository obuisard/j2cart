...
<div class="row">
    <div class="col-sm-12">
        <ul class="nav nav-tabs" id="j2store-product-detail-tab" role="tablist">
			...
			if($this->params->get('item_show_sdesc') || $this->params->get('item_show_ldesc')):?>
                <li class="nav-item">
                    <a class="nav-link active" href="#description" data-toggle="tab" data-bs-toggle="tab"><?php echo Text::_('J2STORE_PRODUCT_DESCRIPTION')?></a>
                </li>
			<?php endif;?>

			<?php if($this->params->get('item_show_product_specification')):?>
                <li class="nav-item" >
                    <a href="#specs" class="nav-link <?php echo isset($set_specification_active) && $set_specification_active ? 'active' : '';?>" data-bs-toggle="tab" data-toggle="tab"><?php echo Text::_('J2STORE_PRODUCT_SPECIFICATIONS')?></a>
                </li>
			<?php endif;?>
