...
CREATE TABLE IF NOT EXISTS `#__j2store_orderitemattributes` (
  ...
  `orderitemattribute_price` decimal(12,4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__j2store_orderitems` (
  ...
  `orderitem_price` decimal(12,4) NOT NULL,
